    ...
    <div class="rbt-contact-address rbt-section-gap">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="thumbnail">
                        <img class="w-100 radius-6" src="http://kursy.existparts.ru/wp-content/themes/histudy/assets/images/about/contact.jpg" alt="Contact Images">
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                        ...
                        <form id="contact-form" action="mail.php" class="max-width-auto">
