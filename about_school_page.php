                        ...
                        <div class="rbt-tutor-information">
                            <div class="rbt-tutor-information-left">
                                <div class="thumbnail rbt-avatars size-lg">
                                    <img src="http://kursy.existparts.ru/wp-content/themes/histudy/assets/images/team/avatar.jpg" alt="Instructor">
                                </div>
                            ...
                            <div class="col-lg-2 offset-lg-2">
                                <div class="feature-sin best-seller-badge text-end h-100">
                                    <span class="rbt-badge-2 w-100 text-center badge-full-height">
                                        <span class="image"><img src="http://kursy.existparts.ru/wp-content/themes/histudy/assets/images/icons/card-icon-1.png" alt="Best Seller Icon"></span> Bestseller
                                    </span>
                                </div>
                            </div>
                        </div>
        ...
        <?get_template_part( 'template-parts/main/feedback' );?>
            ...
            <div class="rbt-profile-course-area mt--60">
                ...
                <div class="row g-5 mt--5">
                    ...
                    <!-- Start Single Card  -->
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12 sal-animate" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-01 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <div class="rbt-progress-style-1 mb--20 mt--10">
                                    <div class="single-progress">
                                        <h6 class="rbt-title-style-2 mb--10">Complete</h6>
                                        <div class="progress">
                                            <div class="progress-bar wow fadeInLeft bar-color-success" data-wow-duration="0.5s" data-wow-delay=".3s" role="progressbar" style="width: 45%; visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInLeft;" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100">
                                            </div>
